...
/// # Testing
///
/// If you want to build fake requests to test your server, use [`TestRequest`](crate::http::tiny_http::test::TestRequest).
pub struct Request {
...
impl Request {
    ...
    pub fn upgrade<R: Read>(
        ...
        use crate::http::tiny_http::util::CustomStream;
