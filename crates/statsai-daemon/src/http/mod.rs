...
//! `src/http/tiny_http/LICENSE-MIT` and `LICENSE-APACHE` (tiny-http and the
//! rust-chunked-transfer decoder this crate vendors a bounded copy of).
...
pub use limits::{
    HttpLimits, BODY_DEADLINE, HEADER_DEADLINE, MAX_ACTIVE_CONNECTIONS, MAX_CHUNK_METADATA_BYTES,
    MAX_HEADERS, MAX_HEADER_BYTES, MAX_HEADER_LINE_BYTES, MAX_QUEUED_REQUESTS, WRITE_DEADLINE,
};
